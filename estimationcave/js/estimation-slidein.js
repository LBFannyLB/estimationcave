...
(function () {
  ...
  var html = ''
    ...
    +     '<h2 class="eos-title">Une estimation offerte&nbsp;?</h2>'
    +     '<p class="eos-sub">Donnez-nous une bouteille de votre cave : un expert indépendant vous renvoie sa cote, sa tendance et un avis garder ou vendre, sous 48&nbsp;h.</p>'
